...
class BookingModel(Base):
    ...
    client: Mapped["UserModel"] = relationship(
        "UserModel", back_populates="bookings", foreign_keys=[client_id]
    )  # noqa: F821
    service: Mapped["ServiceModel"] = relationship(
        "ServiceModel", back_populates="bookings"
    )  # noqa: F821
    review: Mapped["ReviewModel | None"] = relationship(
        "ReviewModel", back_populates="booking", uselist=False, lazy="selectin"
    )  # noqa: F821
